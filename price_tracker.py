...
Info  : https://brightdata.co.kr/products/insights/price-tracker/drouot
"""
...
# https://brightdata.co.kr/products/web-scraper/drouot
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Drouot scraper at: https://brightdata.co.kr/products/web-scraper/drouot\n"
